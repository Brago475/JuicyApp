...
public class AdditionActivity extends AppCompatActivity {
    ...
    //Numbers and correct answer
    private int firstNumber;
    private int secondNumber;
    private int correctAnswer;

    // Media players for sounds
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Link buttons and UI elements to XML layout
        ...
        buttonBack.setOnClickListener(v -> {
            Intent intent = new Intent(AdditionActivity.this, SecondActivity.class);
    ...
    private void showImageFeedback(String feedbackType) {
        ImageView feedbackImage = findViewById(R.id.feedback_image);

...
public class MultiplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonDelete = findViewById(R.id.delete3);
        ...
        buttonBack.setOnClickListener(v -> {
            Intent intent = new Intent(MultiplicationActivity.this, SecondActivity.class);
    ...
    private void showImageFeedback(String feedbackType) {
        ImageView feedbackImage = findViewById(R.id.imageView5);
